...
class GmailMobile(BasePage):
    ...
    def interaction(self, timeout):
        ...
        self.logger('Interacting with Gmail application...')
    ...
    def run_gmail_mobile(self, timeout=50):
        self.logger('Starting Gmail Application...')
        self.mobile_driver.start_activity("com.google.android.gm","com.google.android.gm.ConversationListActivityGmail")
        time.sleep(3)
        # element = self.mobile_driver.find_element(By.XPATH, '// android.widget.Button[ @ content - desc = "Compose"]')
        # element.click()
        # time.sleep(3)


        self.logger('Gmail application started...')
