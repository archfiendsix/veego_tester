...
class TwitchMobile(BasePage):
    ...
    def interaction(self, timeout):
        ...
        self.logger('Interacting with Twitch application...')
    ...
    def run_twitch_mobile(self, timeout=50):
        self.logger('Starting Twitch Application...')
        self.mobile_driver.start_activity("tv.twitch.android.app","tv.twitch.android.feature.viewer.main.MainActivity")
